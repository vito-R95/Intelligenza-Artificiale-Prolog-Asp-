...
5 {partita(andata, SquadraA, SquadraB, Citta, N):
    squadra(SquadraA), 
    squadra(SquadraB), 
    in_citta(SquadraA,Citta),
    SquadraA <> SquadraB} 5 :- turno_andata(N).


% le partite di ritorno sono speculari alle partite di andata ma in altre giornate
5 {partita(ritorno, SquadraA, SquadraB, Citta, N): 
    squadra(SquadraA), 
    squadra(SquadraB), 
    in_citta(SquadraA, Citta),
    partita(andata, SquadraB, SquadraA, Citta2, _),
    in_citta(SquadraB,Citta2)} 5:- turno_ritorno(N).
